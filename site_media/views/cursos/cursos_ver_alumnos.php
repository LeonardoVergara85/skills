...
<head>
  ...
  <title>Sistema Skills - Alumnos por curso</title>
...
<body>
  ...
  <div class="row">
      ...
      <div class="container_contenido">
          ...
          <div class="card">
            <div class="card-header">Cursos - Ver alumnos</div>
            <div class="card-body">
              <form action="">
                <div class="form-row">
  ...
  <script src="../../js/cursos/cursos_ver_alumnos.js" type="text/javascript"></script>
